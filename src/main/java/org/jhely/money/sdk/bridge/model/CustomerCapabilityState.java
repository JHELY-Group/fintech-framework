...
public enum CustomerCapabilityState {
  ...
  CustomerCapabilityState(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static CustomerCapabilityState fromValue(String value) {
    for (CustomerCapabilityState b : CustomerCapabilityState.values()) {
