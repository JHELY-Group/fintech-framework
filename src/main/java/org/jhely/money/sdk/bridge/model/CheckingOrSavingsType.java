 ...
 */
public enum CheckingOrSavingsType {
  ...
  CheckingOrSavingsType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static CheckingOrSavingsType fromValue(String value) {
    for (CheckingOrSavingsType b : CheckingOrSavingsType.values()) {
